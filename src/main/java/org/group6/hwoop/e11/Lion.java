...
public class Lion extends Mammal {
    ...
    public Lion() {
        setAnimalSpecies("lion");
        this.name = "without a name";
        this.age = 0;
        this.location = "Africa";
    }

    public Lion(String name, int age, String location) {
        this();
    ...
    @Override
    public void eat() {
        String[] preys = {"antelope", "zebra", "buffalo", "beef"};
    ...
    void displayInformation() {
        ...
        System.out.print(", I'm " + ((age == 0)? String.format("a %s cub", getAnimalSpecies()):String.format("%d years old", age)));
