...
public class Eagle extends Bird {
    ...
    public Eagle() {
        setAnimalSpecies("eagle");
        this.name = "without a name";
        this.age = 0;
        this.location = "North America";
    }

    public Eagle(String name, int age, String location) {
        this();
    ...
    @Override
    public void eat() {
        String[] preys = {"fish", "small mammal", "bird", "snake"};
    ...
    public void makeSound() {
        String[] sounds = {
                "is screeching.",
                "is whistling 'ki-ki-ki'",
                "is making chirping barks.",
                "is silent.",
                "is making harsh croaks."};
    ...
    void displayInformation() {
        ...
        System.out.print(", I'm " + ((age == 0)? String.format("an eaglet", getAnimalSpecies()):String.format("%d years old", age)));
